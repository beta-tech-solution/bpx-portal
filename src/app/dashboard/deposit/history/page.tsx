...
import { Loader2, CalendarIcon, Eye, ArrowLeft, ArrowRight, User, Phone, Mail } from "lucide-react"
           ...
           {userData && (
             <Card className="mt-4 bg-muted/50">
                ...
                <CardContent className="text-sm space-y-2">
                    <p className="flex items-center gap-2"><User className="h-4 w-4 text-primary" /> {userData.fullName}</p>
                    <p className="flex items-center gap-2"><Mail className="h-4 w-4 text-primary" /> {userData.email}</p>
                    <p className="flex items-center gap-2"><Phone className="h-4 w-4 text-primary" /> {userData.phone}</p>
                    {userData.bpexchUsername && <p className="flex items-center gap-2"><span className="font-bold">BPExch:</span> {userData.bpexchUsername}</p>}
                </CardContent>
             </Card>
           )}
        </CardHeader>
